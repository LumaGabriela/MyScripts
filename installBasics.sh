...
sudo pacman -S plasma-x11-session github-cli php php-pgsql zip texlive texlive-langportuguese texstudio ttf-lato perl-yaml-tiny perl-file-homedir perl-unicode-string
